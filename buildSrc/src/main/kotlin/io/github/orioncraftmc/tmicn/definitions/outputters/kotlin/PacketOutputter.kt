...
import io.github.orioncraftmc.tmicn.definitions.outputters.kotlin.model.TmicnProtocolGenerationModel
...
fun packet(definition: ProtocolDefinition, packet: TmicnPacket): FileSpec {
    ...
    val model = TmicnProtocolGenerationModel(definition, packet)
